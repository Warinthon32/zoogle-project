...
# @user_bp.route('/animals', methods=['GET'])
# def get_all_animals():
#     conn = None
#     try:
...
#         # print("ANIIIIIIIIIIIIIIIIIIIIIIIII", animals)
...
# @user_bp.route('/animals/search', methods=['GET'])
# def search_animals():
...
# @user_bp.route('/animals/<int:id>', methods=['GET'])
